...
public class UserwebProjectController {
    ...
    @GetMapping("/findProject/{project_name}")
    public List<Integer> findProject(@PathVariable String project_name){
        return userwebProjectService.findProject(project_name);
    }
}
