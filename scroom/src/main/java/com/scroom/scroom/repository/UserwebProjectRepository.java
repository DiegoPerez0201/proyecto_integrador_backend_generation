...
public interface UserwebProjectRepository extends JpaRepository<UserwebProject, Integer>{
    ...
    @Query(value= "select Userweb_Project.userweb_project_id from Userweb join Userweb_Project on Userweb.userweb_id = Userweb_Project.userweb_id JOIN Project ON Project.project_id = Userweb_Project.project_id WHERE Project.project_name LIKE ?1", nativeQuery=true)
    List<Integer> findIdbyProjectName(String project_name);
